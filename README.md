...
You will make things appear and disappear (and more) with the magic of DOM!<br>
...
- Make your new wand stand out by adding a `color` of `indigo` (or whatever color you like). But do it with magic: Don't add this css in your `main.css` file
...
- Nosey roommate falls asleep 2 seconds later (use CSS Method)
- Use a DOM method to add CSS to reveal all of your belongings that had a class of secret 
